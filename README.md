...
10. [**User Authentication**:](https://github.com/mah-shamim/simple-user-authentication-system.git) A basic user registration and login system. A minimal implementation lives in this repo at [`simple-user-authentication-system/`](simple-user-authentication-system/).
